    ...
    render() {
        return (
            ...
            <div className="fill1">
                ...
                {this.state.showGoal && (<Goal Goal={this.state.currentgoal} handleClose={this.handleClose} role="student" handletheclose={this.handlegoalsClose} />)}
                            ...
                            this.props.main ?
                                (
                                    <div className="columbized fill2">
                                        ...
                                        <div className="checkboxstuff1  centerized" style={{  width: "100%",marginLeft:"20%"  }} >

                                            <div className="checkboxstuff2 ">
                                                <Checkedd2 main={true} goal={this.props.main} goalStatusChange={this.completeGoal} main={true} />
                                                <h3 style={{ color: "#696eb5" }} className="huv rowss2a" onClick={this.showMainGoal}><div>{this.props.main.title.length > 25 ? (<div className="huv rowss2a" ><Short word={this.props.main.title} wordtype="Goal" /></div>) : (<div className="huv rowss2a" >{this.props.main.title}</div>)}</div></h3>
                                            </div>
                                        ...
                                        <div className="  " style={{ width: "100%", marginLeft:"33%" }}>
                                                            ...
                                                            this.props.goals.map((goal, index) =>
                                                                ...
                                                                <div className="checkboxstuff1 rowss" key={index} >
                                                                    ...
                                                                    <div className="checkboxstuff2">
                                                                        ...
                                                                        <div style={{ marginBottom: "7px" }}  className="huv" onClick={this.showGoal.bind(this, goal)}> <div>{goal.title.length > 14 ? (<div><Short word={goal.title} wordtype="goal" /></div>) : (<div>{goal.title}</div>)}</div></div>
                                                        ...
                                                        this.props.goals.map((goal, index) =>
                                                            ...
                                                            <div className="checkboxstuff1 rowss" key={index} style={{ width: "350px" }} >
                                                                ...
                                                                <div className="checkboxstuff2">
                                                                    ...
                                                                    <div style={{ marginBottom: "5px" }}  className="huv" onClick={this.showGoal.bind(this, goal)}><div>{goal.title.length > 14 ? (<div><Short word={goal.title} wordtype="goal" /></div>) : (<div>{goal.title}</div>)}</div></div>
                                    ...
                                    <div className="centerized" style={{ marginBottom: "10px", width: "100%", height: "100%" }}>
                                        {this.props.main ?
                                            ...
                                            (<div style={{ width: "100%", height: "100%" }} ><div className="centerizeaa homeworkScroll" >
                                                    ...
                                                    <div className="centerized"style={{ width: "200px" }}><Points day={false} role={this.props.role} /> </div>
                                                <div>
                                                    {this.props.totalDays ?
                                                            ...
                                                            <Day role={this.props.role} day={true} daysPracticed={this.props.daysPracticed} totalDays={this.props.totalDays} setDays={this.setDays} open={this.setday} />
                                                                ...
                                                                <div className="centerized" style={{ width: "100%" }}>
                                                                    <Day role={this.props.role} day={true} daysPracticed={this.props.daysPracticed} totalDays={this.props.totalDays} setDays={this.setDays} open={this.setday} /></div></div>
